...
[![NPM](https://img.shields.io/npm/v/@dharitri-sdk/dapp.svg)](https://www.npmjs.com/package/@dharitri-sdk/dapp) [![JavaScript Style Guide](https://img.shields.io/badge/code_style-standard-brightgreen.svg)](https://standardjs.com)

See [Dapp template](https://template-dapp.dharitri.org/) for live demo or checkout usage in the [Github repo](https://github.com/DharitriOne/drt-template-dapp)
...
```bash
npm install @dharitri-sdk/dapp
```

or

```bash
yarn add @dharitri-sdk/dapp
```
...
```bash
npm install @dharitri-sdk/dapp --no-optional
```

or

```bash
yarn add @dharitri-sdk/dapp --no-optional
```

### **If you're transitioning from dapp-core 1.x to @dharitri-sdk/dapp (dapp-core 2.0), please read the [Migration guide](https://github.com/DharitriOne/drt-sdk-dapp/wiki/Migration-guide-2.0)**

### **As of @dharitri-sdk/dapp@2.28.0 Node >=18 is required since Node 16 [reached its EOL](https://nodejs.org/en/blog/announcements/nodejs16-eol).**
...
`import * as DappUI from "@dharitri-sdk/dapp/UI";`
...
```typescript
import { UnlockPage } from '@dharitri-sdk/dapp/UI/pages';
or;
import { UnlockPage } from '@dharitri-sdk/dapp/UI/pages/UnlockPage';
```
...
```typescript
import { DappProvider } from '@dharitri-sdk/dapp/wrappers/DappProvider';
or;
import { DappProvider } from '@dharitri-sdk/dapp/wrappers';
```
...
```jsx
  import {TransactionsToastList} from "@dharitri-sdk/dapp/UI/TransactionsToastList";
...
```jsx
import { SignTransactionsModals } from '@dharitri-sdk/dapp/UI/SignTransactionsModals';
...
```jsx
import { NotificationModal } from '@dharitri-sdk/dapp/UI/NotificationModal';
...
```typescript
import { AuthenticatedRoutesWrapper } from '@dharitri-sdk/dapp/wrappers/AuthenticatedRoutesWrapper';
or;
import { AuthenticatedRoutesWrapper } from '@dharitri-sdk/dapp/wrappers';
```
...
```typescript
import { AxiosInterceptorContext } from '@dharitri-sdk/dapp/wrappers/AxiosInterceptorContext';
```
...
import {
  ...
  useLedgerLogin,
  useWebWalletLogin
} from '@dharitri-sdk/dapp/hooks';
or;
import { useExtensionLogin } from '@dharitri-sdk/dapp/hooks/login/useExtensionLogin';
import { useWalletConnectV2Login } from '@dharitri-sdk/dapp/hooks/login/useWalletConnectV2Login';
import { useLedgerLogin } from '@dharitri-sdk/dapp/hooks/login/useLedgerLogin';
import { useWebWalletLogin } from '@dharitri-sdk/dapp/hooks/login/useWebWalletLogin';
```
...
`import { sendTransactions } from "@dharitri-sdk/dapp";`
...
`import { sendBatchTransactions } from "@dharitri-sdk/dapp/services/transactions/sendBatchTransactions";`
...
- `batchId` is the transactions' batch id used to send the batch to the batch service and to track the transactions status and react to it. This is composed by the `sessionId` (received after signing) and the user address. Eg. `12123423123-moa1address...`.
...
```typescript
import { sendBatchTransactions } from '@dharitri-sdk/dapp/services/transactions/sendBatchTransactions';
import { useSendBatchTransactions } from '@dharitri-sdk/dapp/hooks/transactions/batch/useSendBatchTransactions';
...
```typescript
import {useTrackTransactionStatus} from @dharitri-sdk/dapp/hooks;
...
moduleNameMapper: {
    '@dharitri-sdk/dapp/(.*)':
      '<rootDir>/node_modules/@dharitri-sdk/dapp/__commonjs/$1.js'
},
```
...
```typescript
import { useExtensionLogin } from '@dharitri-sdk/dapp/hooks/login';
import { useGetAccountInfo } from '@dharitri-sdk/dapp/hooks/account';
```
...
} from '@dharitri-sdk/dapp/constants';
```
...
import {
  ...
  useWalletConnectV2Login,
  useWebWalletLogin
} from '@dharitri-sdk/dapp/hooks/login';
```
...
} from '@dharitri-sdk/dapp/hooks/account';
```
...
} from '@dharitri-sdk/dapp/hooks/transactions';
```
...
import {
  ...
  signTransactions,
  calcTotalFee
} from '@dharitri-sdk/dapp/services';
```
...
import {
  ...
  setNonce,
  signMessage
} from '@dharitri-sdk/dapp/utils/account';
```
...
import {
  ...
  nominate,
  getUsdValue
} from '@dharitri-sdk/dapp/utils/operations';
```
...
} from '@dharitri-sdk/dapp/utils/transactions';
```
...
import {
  ...
  AuthenticatedRoutesWrapper,
  AppInitializer
} from '@dharitri-sdk/dapp/wrappers';
```

## Web-specific imports

```typescript
import { useIdleTimer } from '@dharitri-sdk/dapp/web';
```
...
import {
  ...
  WalletConnectLoginContainer,
  WebWalletLoginButton
} from '@dharitri-sdk/dapp/UI';
```

or

```typescript
import { CopyButton } from '@dharitri-sdk/dapp/UI/CopyButton';
import { FormatAmount } from '@dharitri-sdk/dapp/UI/FormatAmount';
import { ExplorerLink } from '@dharitri-sdk/dapp/UI/ExplorerLink';
...
Until then, you can use @dharitri-sdk/moajs libraries and @walletconnect to connect to the xPortal App.
There are also guide for doing this from the [community](https://github.com/sash20m/react-native-xportal)

## Next.js support

If you are using [Next.js](https://nextjs.org/), make sure to check out the [README](https://github.com/DharitriOne/drt-template-nextjs-dapp/blob/main/README.md) and implementation of the [Next.js Template dApp](https://github.com/DharitriOne/drt-template-nextjs-dapp).

## WalletConnect 2.0 Setup

Starting with the 2.0 version of the dApp SDK ( previously `@numbatnetwork/dapp-core@2.0.0` ) and `@dharitri-sdk/dapp@2.2.8` [WalletConnect 2.0](https://docs.walletconnect.com/2.0/) is available as a login and signing provider, allowing users to login by scanning a QR code with the Mobile App

This is an implementation of [sdk-wallet-connect-provider](https://github.com/DharitriOne/drt-sdk-js-wallet-connect-provider) ( [docs](https://docs.dharitri.org/sdk-and-tools/sdk-js/sdk-js-signing-providers/#the-wallet-connect-provider) ) signing provider
...
### Integration Guide
For applications utilizing `@dharitri-sdk/dapp` and aiming to interact with the parent window, integration involves upgrading to the latest version of `@dharitri-sdk/dapp`
...
See the [open issues](https://github.com/DharitriOne/drt-sdk-dapp/issues) for a list of proposed features (and known issues).
