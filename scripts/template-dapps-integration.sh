...
git clone https://github.com/DharitriOne/drt-sdk-dapp.git
...
git clone https://github.com/DharitriOne/drt-template-dapp.git
...
git clone https://github.com/DharitriOne/drt-template-dapp-nextjs.git
