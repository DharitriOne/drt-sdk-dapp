...
import { providerNotInitializedError } from '@dharitri-sdk/dapp-utils/out/helpers/providerNotInitializedError';
import { WebviewProvider } from '@dharitri-sdk/webview-provider/out/WebviewProvider';
...
/**
 * This is an experimental provider that uses @dharitri-sdk/webview-provider to handle the communication between .
