...
describe('removeTransactionParamsFromUrl tests', () => {
  test('removes all data from URL', () => {
    const search =
      '?nonce=1&value=123&receiver=moa123&sender=moa456&gasLimit=60000&gasPrice=60000&chainID=D';
    const transaction = {
      value: '123',
      data: 'test',
      nonce: '1',
  ...
  test('removes only tx data from the URL ', () => {
    const search =
      '?testParam=123&searchParam=asd&nonce=1&value=123&receiver=moa123&sender=moa456&gasLimit=60000&gasPrice=60000&chainID=D';
    const transaction = {
      value: '123',
      data: 'test',
      nonce: '1',
