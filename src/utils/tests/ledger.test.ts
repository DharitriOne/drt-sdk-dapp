...
import { HWProvider } from '@dharitri-sdk/hw-provider/out/hwProvider';
import LedgerApp from '@dharitri-sdk/hw-provider/out/ledgerApp';

// Mock the LedgerApp class
jest.mock('@dharitri-sdk/hw-provider/out/ledgerApp', () => {
