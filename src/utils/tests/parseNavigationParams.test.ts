...
describe('parseNavigationParams tests', () => {
  it('Returns remaining params without signature', () => {
    ...
    expect(params).toStrictEqual({
      address: 'moa1dm9uxpf5awkn7uhju7zjn9lde0dhahy0qaxqqlu26xcuuw27qqrsd3akwp',
      page: '1'
    });
